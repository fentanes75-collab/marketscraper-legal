...
Acceptable Use: Users agree to extract marketplace data responsibly and in compliance with applicable platform rules and local regulations.

Refund Policy: Due to the immediate delivery of digital software licenses, refund requests are governed by Lemon Squeezy buyer terms or honored within 14 days of purchase in case of technical issues that cannot be resolved.

Privacy Policy
MarketScraper Pro is built with privacy-first standards:

Local Data Processing: All catalog extraction and CSV generation are executed entirely client-side within your browser. We never transmit, store, or sell your extracted data.
